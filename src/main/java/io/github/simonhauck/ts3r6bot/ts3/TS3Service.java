...
public class TS3Service {
    ...
    public static TS3ServiceSingleton _singleton = null;
    ...
    public TS3Service(Environment environment) {
        if (_singleton == null) {
            _singleton = new TS3ServiceSingleton(environment);
        }
    }
    ...
    public ITS3EventDispatcher getEventDispatcher() {
        if (_singleton != null) {
            return _singleton.getEventDispatcher();
        } else {
            return null;
        }
    ...
    public TS3ApiAsync getTs3AsyncApi() {
        if (_singleton != null) {
            return _singleton.getTs3AsyncApi();
        } else {
            return null;
        }
    }
    ...
    private static class TS3ServiceSingleton {
        ...
        public TS3ServiceSingleton(Environment environment) {
